...
if (isset($_POST['btnSubmit'])) {
    ...
    $mensagem = "Você esta recebendo este e-mail, por que foi solicitado a alteração de senha para o site, clique no link abaixo para redefinir sua senha. <br /><a href='http://www.portalconstrutora.com.br/cotacao/redefinirSenha.php?conta={$mailCript}'>Recuperar Senha</a>";
