...
foreach($dados as $key => $linha){
	...
	if ($tipo == "C") {
		...
		if($key == 0) {
			...
			$mensagem = "Você esta recebendo este e-mail, por que foi solicitado uma cotação de número ".$idprincipal." nova através do site NOME_SITE, clique no link abaixo para visualizar. <br /><a href='http://http://www.portalconstrutora.com.br/cotacao'>Acessar Site</a>";
