...
<html lang="pt-br">
    ...
    <body>
			...
			<div class="container">
				<h3 class="page-header">Olá, Fornecedor - <?=$_SESSION["idfornecedor"];?> - <?=$_SESSION["nomefornecedor"];?></h3>
				<?php
			...
			<h4 class="">Última cotação solicitada</h4>
			<table class="table">
			<thead>
				<tr>
			...
			<tbody>
					<?php
						...
						$query = "select * from cliente c inner join fornecedor f on c.idprincipal = f.idprincipal where f.fornecedor_campo2 = ".$_SESSION["idfornecedor"]." order by c.cliente_campo8";
					...
					<tr>
						...
						<td width="400">
							<?php echo date('d/m/Y h:m:s', strtotime($linha["cliente_campo8"]));?>
						</td>
					</tr>	
					<?php
					}	
			...
			<div style="text-align: right;">
				<a href="cotacoessolicitadas.php" class="btn btn-danger btn-md" role="button">Ver lista de solicitação de cotações - Clique aqui.</a>
			</div>	
        </div>
