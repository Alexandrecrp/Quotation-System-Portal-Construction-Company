...
<html lang="pt-br">
    ...
    <body>
			...
			<div class="container">
			<h3 class="page-header">Cotações Solicitadas</h3>
			<table class="table">
			<thead>
				<tr>
				  ...
				  <th scope="col"><center>Data de solicitação de cotação<center></th>
				  <th scope="col"><center>Ver mais</center></th>
				</tr>
			  </thead>
			<tbody>
					<?php
						//fazendo uma consulta SQL e retornando os resultados								
						$query = "select * from cliente c inner join fornecedor f on c.idprincipal = f.idprincipal where f.fornecedor_campo2 = ".$_SESSION["idfornecedor"]." order by c.cliente_campo8 DESC";
					...
					<tr>
						...
						<?php
						$querytrava = "select * from travafornecedor where idfornecedor = ".$_SESSION["idfornecedor"]." and idprincipal = ".$linha["idprincipal"]."";
						...
						<td width="400">
							<center>
								<a href="abrecotacaosolicitada.php?idprincipal=<?php echo $linha["idprincipal"];?>" class="btn btn-danger btn-md" role="button">Enviar cotação</a>
							</center>
						</td>
						<?php
							...
							<td width="400">
							<center>
								<a href="abrecotacaosolicitada.php?idprincipal=<?php echo $linha["idprincipal"];?>" class="btn btn-success" role="button">Cotação enviada</a>
							</center>
						</td>
						<?php
						}
