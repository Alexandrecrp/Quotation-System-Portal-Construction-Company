...
<html lang="pt-br">
    ...
    <body>
			...
			<div class="container">
			<h3 class="page-header">Cotações enviadas por <?=$_SESSION["email"];?></h3>
			<table class="table">
			<thead>
				<tr>
			...
			<tbody>
					...
					<tr>
						...
						<td width="400">
							<center>
								<a href="vercotacaoadm.php?idprincipal=<?php echo $linha["idprincipal"];?>" class="btn btn-danger btn-md" role="button">Ver dados cotação</a>
							</center>	
						</td>
					</tr>	
					<?php
